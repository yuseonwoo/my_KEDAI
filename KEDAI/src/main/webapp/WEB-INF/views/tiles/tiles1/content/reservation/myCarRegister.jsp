...
//          $('span#insuranceError').show();
        ...
        frm.action = "<%= ctxPath%>/myCarRegisterEnd.kedai"; 
        frm.method = "post";
        frm.submit();
    }
        ...
        <div class="col-10 row" id="empRegister">
            <div class="col-6 register" style="border: 0px solid blue;">
                ...
                <div class="mt-3" style="display: flex;">
                    ...
                    <select name="drive_year" id="drive_year" class="requiredInfo" style="width: 170px;">
            ...
            <div class="col-6 register" style="border: 0px solid blue; position: relative;">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="car_num" id="car_num" size="6" maxlength="20" class="requiredInfo" placeholder="차량번호" />    
                </div>
